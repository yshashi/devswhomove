  ...
  template: `
    <header class="overflow-hidden relative bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800">
      <div class="absolute inset-0">
        <div class="absolute inset-0 bg-gradient-to-r from-blue-500/10 to-purple-500/10 dark:from-blue-500/20 dark:to-purple-500/20"></div>
      </div>
      <div class="relative px-4 py-24 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="text-center">
          ...
          <p class="mx-auto mt-3 max-w-md text-xl text-gray-600 dark:text-gray-300 sm:text-2xl md:mt-5 md:max-w-3xl">
            Where code meets movement - Join a community of developers who balance debugging with physical activities
          </p>
          <div class="flex gap-x-6 justify-center mt-10">
            <div class="flex gap-4 mb-6">
              <div class="px-6 py-4 bg-white rounded-lg shadow-sm dark:bg-gray-800">
                <div class="flex items-center">
                  <svg class="w-6 h-6 mr-3 text-blue-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
              ...
              <div class="px-6 py-4 bg-white rounded-lg shadow-sm dark:bg-gray-800">
                <div class="flex items-center">
                  <svg class="w-6 h-6 mr-3 text-green-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
